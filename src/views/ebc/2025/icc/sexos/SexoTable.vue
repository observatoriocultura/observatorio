...
<template>
  <div class="sexo-table">
    <div class="card-premium overflow-hidden">
      <div class="card-header bg-white border-0 py-3 px-4 d-flex justify-content-between align-items-center">
        <h6 class="text-uppercase text-muted fw-bold small mb-0">
          <i class="bi bi-gender-ambiguous text-premium me-2"></i>Resultados por Sexo
        </h6>
      ...
      <div v-if="loading" class="text-center p-5">
        ...
        <div class="text-muted mt-2 small">Cargando datos por sexo...</div>
      </div>
        ...
        <table class="table table-hover align-middle mb-0">
          <thead class="table-light text-muted small text-uppercase">
            <tr>
              ...
              <th scope="col" class="border-0 py-2">Sexo</th>
