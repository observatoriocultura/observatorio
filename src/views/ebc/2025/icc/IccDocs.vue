...
<template>
  <div class="icc-docs-container container my-5">
    <div class="row justify-content-center">
      <div class="col-lg-10">
        ...
        <header class="docs-header mb-5 text-center">
          ...
          <h1 class="docs-title">Documentación Técnica: Visualizador EBC</h1>
          <p class="docs-subtitle text-muted mt-3">
            Estructura lógica, flujo de datos relacional y procesamiento reactivo del dashboard de Encuesta de Cultura Ciudadana.
          </p>
        </header>
          ...
          <div class="card shadow-sm border-0 docs-card">
            <div class="card-body p-4 p-lg-5">
              <div class="d-flex align-items-center mb-4">
                ...
                <h3 class="section-title mb-0">1. Arquitectura Base (IccLayout.vue)</h3>
              </div>
              <p>
                El componente <code>IccLayout.vue</code> actúa como la piedra angular de la aplicación. Su función principal es comportarse como el contenedor (Layout) que enruta y mantiene vivos los estados de las vistas internas.
              </p>
              <ul>
        ...
        <section class="docs-section mb-5">
          <div class="card shadow-sm border-0 docs-card">
            <div class="card-body p-4 p-lg-5">
              ...
              <p>
                El motor de resultados (<code>IccResultados.vue</code>) prescinde de APIs dinámicas e implementa una ingesta rápida de archivos <strong>JSON pre-procesados y estáticos</strong> alojados en el servidor, maximizando concurrencia y velocidad.
              </p>
        ...
        <section class="docs-section mb-5">
          <div class="card shadow-sm border-0 docs-card">
            <div class="card-body p-4 p-lg-5">
              ...
              <h5 class="mt-4 mb-3 fw-bold text-dark mt-5">Panel de Inspección (IccDebug.vue)</h5>
              <p>
